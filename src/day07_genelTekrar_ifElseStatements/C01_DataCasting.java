...
public class C01_DataCasting {
    public static void main(String[] args) {
        ...
        String str2= 20;
        boolean bl1= 'a';
        int sayi1= "Merhaba";   bunları yazdırsak altını kırmızıya boyar
         */
        ...
        System.out.println("sayi3 : " + sayi3);  // 39878767


        short sh2= (short)db1;
        System.out.println("sh2 : " + sh2);   // aktardığında ne kdar kalıyorsa onu yazdırır

        String str5= "112";
        short sh3= Short.parseShort(str5);

        System.out.println("sh3 un iki kati : " + sh3*2);  // 224
