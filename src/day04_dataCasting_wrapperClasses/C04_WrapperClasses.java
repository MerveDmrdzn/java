...
public class C04_WrapperClasses {
    public static void main(String[] args) {
        ...
        String sonucStr= "345";
        System.out.println(sonucStr + 10); // 345+10 top gibi değil string olduğu için yanyana yazdırır

        // bu degere 10 ekleyin
        // int sonuc= (int)sonucStr; // bununla yapamayız çünkü bu işlem primitive dataların kendı ıcındedır
        // bu durumda Wrapper class'lar imdada yetisir,non prımıtıveler ıcınde wrapperlar vardır
