...
import day17_arrays.C05_ArayeElemanEkleme;
import day17_arrays.C07_ArrayeElemanEklemeMethodu;
...
public class C02_ArrayList {
    public static void main(String[] args) {
        ...
        arr = C07_ArrayeElemanEklemeMethodu.arrayeElementEkle(arr,5);

        System.out.println(Arrays.toString(arr)); // [3, 4, 5]

        arr = C07_ArrayeElemanEklemeMethodu.arrayeElementEkle(arr,15);
